var shoppingCart = (function () {
  ...
  function displayCart() {
    ...
    for (var i in cartArray) {
      output += "<tr>"
        ...
        + "<td><div class='input-group'><button class='btn btn-minus' id='minusBtn'>-</button>"
        + "<input type='number' class='item-count form-control' data-name='" + cartArray[i].name + "' value='" + cartArray[i].count + "'>"
        + "<button class='btn btn-plus' id='plusBtn'>+</button></div></td>"
        + " = "
  ...
  $("#minusBtn").click(function () {
    var currentValue = parseInt($(".item-count").val());
    if (currentValue > 1) {
      $(".item-count").val(currentValue - 1);
    }
  });
